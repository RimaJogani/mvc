        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
             ...
             <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="javascript:void(0)" onclick="mage.setUrl('<?php echo $this->getUrl('Admin1','gridHtml',[],true)?>').load();">Admin</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="javascript:void(0)" onclick="mage.setUrl('<?php echo $this->getUrl('Cart','gridHtml',[],true)?>').load();">Cart</a>
              </li>
             <!--  <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" onclick="mage.setUrl('<?php echo $this->getUrl('placeorder','gridHtml',[],true)?>').load();" href="javascript:void(0)" >order</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" onclick="mage.setUrl('<?php echo $this->getUrl('ConfigGroup','gridHtml',[],true)?>').load();" href="javascript:void(0)" >Config Group</a>
              </li>
